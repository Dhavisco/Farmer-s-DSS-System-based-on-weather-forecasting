...
const Recommendation = ({ cropData, weatherData, city, setCity, error }) => {
  ...
  return (
    <>
      ...
      <div className="container  flex justify-center items-center  fade-in">
        <div className="p-2 container mx-4 w-full">
        ...
        <p>
          ...
          {error && (
            <div className="lg:w-5/6 flex justify-center text-red-500 font-medium">
